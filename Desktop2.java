	...
	private static void desktopTester() {
		...
		try (Socket svrSocket = new Socket("localhost", 1234)) {
	        ...
	        do{
	        	...
	        	// reading from user
	        	System.out.print("Username(Goat): ");
	        	line = sc.nextLine();
	        	message = new Message("2","desktop","login","",line);
	        ...
	        while(!"logout".equalsIgnoreCase(line)){
	        	...
	        	if("logout".equalsIgnoreCase(line)) {
	        		message = new Message("2","desktop",line,"","");
	        		objectOutputStream.writeObject(message);
	        		message = (Message)objectInputStream.readObject();
	        		System.out.println("Logout: " + message.getStatus());
	        	}
	        	if("a-sheep".equalsIgnoreCase(line)) {
	        		message = new Message("2","desktop","authorization","","Sheep,3456");
	        		objectOutputStream.writeObject(message);
	        		message = (Message)objectInputStream.readObject();
	        		System.out.println("Authorization: " + message.getStatus());
	        	}
	        	if("a-ram".equalsIgnoreCase(line)) {
	        		message = new Message("2","desktop","authorization","","Ram,2345");
	        		objectOutputStream.writeObject(message);
	        		message = (Message)objectInputStream.readObject();
	        		System.out.println("Authorization: " + message.getStatus());
	        	}
	        	if("inquiry".equalsIgnoreCase(line)) {
	        		System.out.print("Please enter the account#<6789>: ");
	        		accountNum = sc.nextLine();
	        		System.out.print("Card#<999999>: ");
	        		cardNum = sc.nextLine();
	        		System.out.print("Enter pin<0303>: ");
	        		pin = sc.nextLine();
	        		String text = accountNum + "," + cardNum + "," + pin;
	        		//message = new Message("1","desktop","inquiry","","4567,888888,0202");
	        		message = new Message("2","desktop","inquiry","",text);
	        		objectOutputStream.writeObject(message);
	        		message = (Message)objectInputStream.readObject();
	        	...
	        	if("update".equalsIgnoreCase(line)) {
	        		...
	        		message = new Message("2","desktop","update","",upCust.toString()+","+upAccount.toString());
	        		objectOutputStream.writeObject(message);
	        		message = (Message)objectInputStream.readObject();
	        		if("success".equalsIgnoreCase(message.getStatus())) {
